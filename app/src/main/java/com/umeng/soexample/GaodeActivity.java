...
public class GaodeActivity extends AppCompatActivity implements LocationSource, AMapLocationListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        PermissionUtils.permission(this, new PermissionUtils.PermissionListener() {
            ...
            public void success() {
                // 设置定位监听
                aMap.setLocationSource(GaodeActivity.this);
    ...
    public void onLocationChanged(AMapLocation amapLocation) {
        if (mListener != null && amapLocation != null) {
            if (amapLocation != null
                ...
                Toast.makeText(GaodeActivity.this, country + "==" + city + "==" + street + "===" + dis + "==" + num + city_code + "==" + tude + "===" + longitude, Toast.LENGTH_SHORT).show();
